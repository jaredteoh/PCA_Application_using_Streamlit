...
if uploaded_file is not None:
    ...
    categorical_variable_1 = settings_column.selectbox("First Variable Select", options=cat_cols)
    ...
    scatter_column.plotly_chart(px.scatter(data_frame=pca_data, x=pca_1, y=pca_2, color=categorical_variable_1, template="simple_white", height=800, hover_data=[categorical_variable_2]), use_container_width=True)
